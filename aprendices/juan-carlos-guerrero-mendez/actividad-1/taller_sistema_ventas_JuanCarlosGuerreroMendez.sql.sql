...
-- ==============================================================================
-- Nombre del Aprendiz: _Juan Carlos Guerrero Mendez_______________________________________________________
...
insert into productos (codigo_barras, nombre, precio, stock, categoria_id) values ('6576hvghc7dsd78', 'Zapatos CR7', '7000', '777', '2' );
insert into productos (codigo_barras, nombre, precio, stock, categoria_id) values ('457sdvsf76sd7f8', 'clavos invisibles', '670', '607', '1' );
insert into productos (codigo_barras, nombre, precio, stock, categoria_id) values ('S54G5SDFSA665D6', 'GTA 6 DEMO', '1000', '180', '3' );
insert into productos (codigo_barras, nombre, precio, stock, categoria_id) values ('fgd46gk565kme66', 'Minecraft', '1605.56', '351', '3' );
...
-- Escriba la sentencia aquí:  ALTER TABLE usuario ADD COLUMN telefonos VARCHAR(20) UNIQUE;

  --Respuesta:
    --Gracias a ALTER TABLE ADD se pudo agregar en la tabla usuario la columna telefonos con su tipo de VARCHAR Y UNIQUE.
...
-- Escriba su respuesta técnica en este comentario: la Base de Datos se niega a borrarlo es porque en esa categoria se encuentran enlazados varios productos con llaves foreign key
/*
  Respuesta:
    DELETE FROM categorias WHERE id = 1;
    --el error que nos arrroja la Base de Datos es:
      [Error Code: 1451. Cannot delete or update a parent row: 
      a foreign key constraint fails (`taller_ventas_adso`.`productos`, CONSTRAINT `fk_categorias_producto` 
