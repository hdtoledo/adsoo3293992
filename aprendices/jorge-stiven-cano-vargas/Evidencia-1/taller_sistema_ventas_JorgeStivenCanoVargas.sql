...
-- ==============================================================================
-- Nombre del Aprendiz: Jorge Stiven Cano Vargas
...
create database if not exists taller_sistema_ventas_JorgeCano
default character set utf8mb4
collate utf8mb4_unicode_ci

-- [TODO 1.3]: Ponga en uso la base de datos creada.

use taller_sistema_ventas_JorgeCano;
...
create table usuarios (
  ...
  rol enum('ADMIN', 'VENDEDOR', 'CLIENTE') defaul 'CLIENTE',
