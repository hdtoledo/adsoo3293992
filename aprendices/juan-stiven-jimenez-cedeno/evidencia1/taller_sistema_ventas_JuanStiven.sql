...
insert usuarios (documento, nombre, email, rol, activo) values
('1077854145', 'juan stiven', 'juan@gmail.com', 'admi', 1),
('1234567890', 'keissy benitez', 'keissy@gmail.com', 'vendedor', 1),
('2345678915', 'eithan eliam', 'eithan@gmial.com', 'cliente', 1);


-- [TODO 3.2]: Inserte al menos 3 categorías (ej. Ferretería, Hogar, Calzado, etc.).
insert categorias (nombre, descripcion, activo) values
('ferreteria', 'elementos de construccion', 1),
('papeleria', 'elementos escolares', 1),
('hogar', 'elementos de aseo', 1);

-- [TODO 3.3]: Inserte al menos 4 productos vinculados a categorías existentes.
insert productos (codigo_barras, nombre, precio, stock, categorias_id) values
('TECH-001', 'martillo', 10000.00, 15, 1),
('TECJ-002', 'bloc cuadriculado', 7500.00, 25, 2),
('TECK-001', 'escoba roja', 4000.00, 50, 3),
('TECK-003', 'escoba VERDE', 4000.00, 50, 3);
...
add column telefono varchar (15) unique;

--para agregar el numero del usuario colocamos el siguinete codigo--
update usuarios 
set telefono = '3125873602'
where documento = '1077854145';
...
/*
Respuesta:
el motor muestra el error 1451 porque la categoria que intente borrar esta vinculada con varios productos los cuales no se pueden dejatr solos ya que depende de la misma, teniendo encuenta que dentro del codigo colocamos la restrincion (on delete reintrict)
*/