...
-- ==============================================================================
-- Nombre del Aprendiz: Eliana Mildreth Varela Nupan
...
-- [TODO 1.3]: Ponga en uso la base de datos 
...
('1081638476', 'eliana ', 'elianas326@email.com', 'ADMIN'),
('1939347343', 'stiven ', 'stiven93@email.com', 'VENDEDOR'),
('1828832937', 'paula ', 'paula825@email.com', 'CLIENTE');
...
-- [TODO 3.3]: Inserte al menos 4 productos vinculados a categorías existentes.
 ...
 ('PFFD001', 'Martillo', 25.000, 15, 1),
 ('PFFD002', 'cobija', 50.000, 8, 2),
 ('PFFD003', 'olla', 30.000, 12, 2),
 ('PFFD004', 'Zapatillas', 120.000, 20, 3);
...
/*
  Respuesta:
    ...
    Sale un error de clave foránea (Foreign Key). La base de datos no lo deja borrar 
  porque hay productos vinculados a esa categoría. Si la borramos, esos productos 
  quedarían huérfanos sin categoría, lo que rompe la integridad de los datos.
*/