...
from usuarios
where activo = 1 and (email like '%@misena.edu.co') and (ciudad= 'garzón' or ciudad = 'pitalito')
...
from productos
where precio between 40000 and 2000000 or categoria_id is null
...
inner join detalle_pedidos on detalle_pedidos.pedido_id = pedidos.id
inner join productos on productos.id = detalle_pedidos.producto_id
