...
-- 3. Verifica cada consulta en MySQL Workbench o DBeaver antes de la sustentación del Bloque 3.
...
from productos 
where precio >= 400000 and precio <= 2000000 or (categoria_id is null)
